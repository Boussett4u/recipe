...
(function () {
    var f = null,
        a = window,
        j = "sitesearch",
        s = a.googleSearchResizeIframe || a.googleSearchPath && a.googleSearchPath == "/cse" && typeof a.googleSearchResizeIframe == "undefined",
        p, o, k;
    ...
    function x() {
        ...
        if (b.cof) {
            var l = t(decodeURIComponent(b.cof), ":", ";", true),
                m = l.FORID;
            if (m) {
                p = parseInt(m, 10)
            }
    ...
    function v() {
        ...
        if (m && c[p]) {
            var d = r(a.googleSearchFrameWidth, c[p]),
                g = r(a.googleSearchFrameHeight, b[p]),
            ...
            m.appendChild(e);
            if (e.attachEvent) {
                e.attachEvent("onload", function (i) {
                    window.scrollTo(0, 0)
                })
            } else {
